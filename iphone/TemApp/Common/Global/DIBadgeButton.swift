...
@IBDesignable
open class DIBadgeButton: UIButton {
     ...
     **/
    private var innerVerticalMargin : CGFloat = 5.0{
     ...
     **/
    private var innerHorizontalMargin : CGFloat = 10.0{
     ...
     **/
    private func calculateXYForBadge(x : inout CGFloat, y : inout CGFloat, badgeSize : CGSize){
