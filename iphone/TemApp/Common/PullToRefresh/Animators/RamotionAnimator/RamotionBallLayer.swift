...
class CircleLayer :CAShapeLayer, CAAnimationDelegate {
    ...
    init(size: CGFloat, moveUpDist: CGFloat, frame: CGRect, color: UIColor = UIColor.white) {
        ...
        spiner = SpinerLayerTwo(superLayerFrame: selfFrame, ballSize: size, color: color)
        super.init()
...
class SpinerLayerTwo: CAShapeLayer, CAAnimationDelegate {
