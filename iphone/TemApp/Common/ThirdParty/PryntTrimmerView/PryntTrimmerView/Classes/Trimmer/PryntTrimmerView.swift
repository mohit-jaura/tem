...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    private func setupTrimmerView() {
        ...
        leftConst = trimView.leftAnchor.constraint(equalTo: leftAnchor)
        rightConst = trimView.rightAnchor.constraint(equalTo: rightAnchor)
    ...
    @objc func handlePanGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            if isLeftGesture {
                currentLeftConstraint = leftConst!.constant
            } else {
                currentRightConstraint = rightConst!.constant
            }
    ...
    private func updateLeftConstraint(with translation: CGPoint) {
        ...
        leftConst?.constant = newConstraint
    }
    ...
    private func updateRightConstraint(with translation: CGPoint) {
        ...
        rightConst?.constant = newConstraint
    }
