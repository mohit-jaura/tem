...
class AssetVideoScrollView: UIScrollView {
    ...
    internal var widthConst: NSLayoutConstraint?
    ...
    private func setupSubviews() {
        ...
        widthConst = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        widthConst = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        widthConst?.isActive = true
        layoutIfNeeded()
