...
public class YPCameraVC: UIViewController, UIGestureRecognizerDelegate, YPPermissionCheckable {
    ...
    override public func viewDidLoad() {
        ...
        //For Zooming Pinch....
        let zoomtapRecognizer = UIPinchGestureRecognizer(target: self, action: #selector(self.pinch(_:)))
        zoomtapRecognizer.delegate = self
       // v.previewViewContainer.addGestureRecognizer(zoomtapRecognizer)
