...
extension UIView {
    ...
    private func recursiveShowSkeleton(withType type: SkeletonType, usingColors colors: [UIColor], animated: Bool, animation: SkeletonLayerAnimation?, root: UIView? = nil) {
    ...
    private func recursiveHideSkeleton(reloadDataAfter reload: Bool, root: UIView? = nil) {
