...
open class VGPlayerCacheManager: NSObject {
    ...
    private let ioQueue = DispatchQueue(label: "com.vgplayer.ioQueue")
    ...
    private func cachedFiles(atPath path: String, onlyForCacheSize: Bool) -> (urlsToDelete: [URL], diskCacheSize: UInt, cachedFiles: [URL: URLResourceValues]) {
