...
public struct VGPlayerDownloaderStatus {
    ...
    private var downloadingURLs: NSMutableSet
    private let downloaderStatusQueue = DispatchQueue(label: "com.vgplayer.downloaderStatusQueue")
...
open class VGPlayerDownloader: NSObject {
    ...
    private var isDownloadToEnd: Bool = false
    private var actionWorker: VGPlayerDownloadActionWorker?
