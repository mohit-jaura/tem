...
open class VGSubtitles {
    ...
    open private(set) var subtitlesFormat : subtitlesFormat = .unknown
    // 存放字幕的字典  时间戳key 字幕value
    open private(set) var subtitlesGroups : [subtitles] = []
    ...
    private func parseSubtitles(_ payload: String) -> [subtitles]  {
    ...
    private func parseStrSubtitles(_ payload: String) -> [subtitles]? {
        var group: [subtitles] = []
    ...
    private func parseAssSubtitles(_ payload: String) -> [subtitles]? {
    ...
    private func decoderSubtitlesFormat(_ filePath: URL) -> subtitlesFormat {
