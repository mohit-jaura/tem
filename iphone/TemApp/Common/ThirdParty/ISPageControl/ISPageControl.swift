...
open class ISPageControl: UIControl {
    ...
    @IBInspectable open var borderWidth1: CGFloat = 0 {
        didSet {
            setNeedsLayout()
        }
    }
    
    @IBInspectable open var borderColor1: UIColor = UIColor.clear {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    open override func layoutSubviews() {
        ...
        dotLayers.forEach {
            if borderWidth1 > 0 {
                $0.borderWidth = borderWidth1
                $0.borderColor = borderColor1.cgColor
            }
        }
