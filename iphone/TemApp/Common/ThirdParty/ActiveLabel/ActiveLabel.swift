...
extension UILabel {
    ...
    func maxLines() -> Int {
        ...
        let textSize = text.boundingRect(with: maxSize, options: .usesLineFragmentOrigin, attributes: [.font: font ?? UIFont()], context: nil)
...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    open override var intrinsicContentSize: CGSize {
        ...
        if let length = singleLineLength,
            self.maxLines() <= 1 {
            return CGSize(width: ceil(size.width), height: length)
        }
