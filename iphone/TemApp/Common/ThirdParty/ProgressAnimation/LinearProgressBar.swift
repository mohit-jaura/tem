...
open class LinearProgressBar: UIView {
    ...
    //PUBLIC VARS
    open var backgroundProgressBarColor: UIColor = UIColor.white//UIColor(red:0.73, green:0.87, blue:0.98, alpha:1.0)
    open var progressBarColor: UIColor = UIColor.appThemeColor//UIColor(red:0.12, green:0.53, blue:0.90, alpha:1.0)
    open var heightForLinearBar: CGFloat = 5
    open var widthForLinearBar: CGFloat = 0
    
    public init () {
        super.init(frame: CGRect(origin: CGPoint(x: 0,y :30), size: CGSize(width: screenSize.width, height: 0)))
    ...
    public init(superview: UIView) {
        ...
        super.init(frame: CGRect(origin: CGPoint(x: 0,y :superView.frame.origin.y), size: CGSize(width: screenSize.width, height: 0)))
        self.progressBarIndicator = UIView(frame: CGRect(origin: CGPoint(x: 0,y :0), size: CGSize(width: 0, height: heightForLinearBar)))
    }
