...
extension UIColor {
    static var ArrowBlue: UIColor {
        return #colorLiteral(red: 0, green: 0.5882352941, blue: 0.8980392157, alpha: 1)
    }
...
open class ArrowRefreshAnimator: UIView, CustomPullToRefreshAnimator {
    ...
    private var activityIndicatorView: UIActivityIndicatorView = UIActivityIndicatorView(style: .gray)
    ...
    public override init(frame: CGRect) {
        ...
        circleFrontLayer.transform = CATransform3DMakeAffineTransform(CGAffineTransform(rotationAngle: CGFloat(-Double.pi/2)))
