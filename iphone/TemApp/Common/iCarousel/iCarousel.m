...
{
    // Fix for issue with carousel items relayout.
    // https://github.com/nicklockwood/iCarousel/issues/145#issuecomment-8858490
    for(UIView* v in self.visibleItemViews) {
        ...
        CGRect sf = v.superview.frame;
        sf.origin.y = 0;
        sf.size.height = self.bounds.size.height;
        v.superview.frame = sf;
    }
