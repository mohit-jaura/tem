...
class CurveAlgorithm {
    ...
    private func controlPointsFrom(points: [CGPoint]) -> [CurvedSegment] {
        ...
        var delta: CGFloat = 0.3 // The value that help to choose temporary control points.
        ...
        for i in 1..<points.count {
            ...
            if self.dataEntries?[i-1].value == 0 {
                delta = 0.0
            } else {
                delta = 0.3
            }
     ...
     */
    func createCurvedPath(_ dataPoints: [CGPoint], dataEntries: [PointEntry]?) -> UIBezierPath? {
