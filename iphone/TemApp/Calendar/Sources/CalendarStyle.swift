...
public struct DaySelectorStyle {
  public var activeTextColor = SystemColors.label
  public var selectedBackgroundColor = SystemColors.systemMainSecondColor
  ...
  public var todayActiveBackgroundColor = SystemColors.systemMainSecondColor
...
public struct CurrentTimeIndicatorStyle {
  ...
  public var font = UIFont(name: UIFont.avenirNextBold, size: 11)
  public var dateStyle : DateStyle = .system
  public init() {}
}

public struct AllDayViewStyle {
    public var backgroundColor: UIColor = UIColor.newAppThemeColor
    public var allDayFont = UIFont(name: UIFont.avenirNextBold, size: 12)
    public var allDayColor: UIColor = .white
  public init() {}
}
