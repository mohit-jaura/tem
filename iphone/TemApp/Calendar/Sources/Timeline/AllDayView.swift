...
public final class AllDayView: UIView {
  ...
  private let allDayEventHeight: CGFloat = 34.0
  ...
  private func configure() {
    ...
    addConstraints([
        ...
        NSLayoutConstraint(item: textLabel, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: allDayEventHeight)
    ])
    ...
    scrollView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: 2).isActive = true
  ...
  public func reloadData() {
    ...
    verticalStackView.trailingAnchor.constraint(equalTo: scrollView.trailingAnchor, constant: 2).isActive = true
    verticalStackView.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 0).isActive = true
    verticalStackView.leadingAnchor.constraint(equalTo: scrollView.leadingAnchor, constant: 2).isActive = true
