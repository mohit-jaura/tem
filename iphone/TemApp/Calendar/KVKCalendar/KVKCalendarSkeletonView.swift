...
final class KVKCalendarSkeletonView: UIView {
...
extension UIView {
    ...
    private var skeletonView: KVKCalendarSkeletonView {
        guard let view = objc_getAssociatedObject(self, &skeletonViewAssociationKey) as? KVKCalendarSkeletonView else {
            let view = KVKCalendarSkeletonView()
